...
export declare class ClientDeshredDuplexStream extends Duplex {
    private _napiDuplexStream;
    private _readInFlight;
    private _isClosed;
    private _isDestroying;
    ...
    _read(_size: number): void;
    _destroy(error: Error | null, callback: (error?: Error | null) => void): void;
    _write(chunk: SubscribeDeshredRequest, _encoding: BufferEncoding, callback: (error?: Error | null) => void): void;
}
export declare const txEncode: {
    encoding: any;
    encode_raw: typeof napi.encodeTx;
    encode: <T extends napi.WasmUiTransactionEncoding>(message: SubscribeUpdateTransactionInfo, encoding: T, max_supported_transaction_version: number | undefined, show_rewards: boolean) => MapTransactionEncodingToReturnType[T];
};
export declare const txDeshredEncode: {
    encoding: any;
    encode_raw: typeof napi.encodeDeshredTx;
    encode: <T extends napi.WasmUiTransactionEncoding>(message: SubscribeUpdateDeshredTransactionInfo, encoding: T) => DeshredTransactionEncodingToReturnType<T>;
};
export declare const txErrDecode: {
    decode_raw: typeof napi.decodeTxError;
